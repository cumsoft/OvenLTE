...
class C(B.Tk):
	def __init__(A):B.Tk.__init__(A);A.title('Cumsoft_OvenLTE_App');A.temperature_gauge=B.Canvas(A,width=200,height=100,bg='white');A.temperature_gauge.pack();A.temperature_label=B.Label(A,text='Temperature: N/A',font=('Helvetica',16));A.temperature_label.pack();A.update_button=B.Button(A,text='Reset',command=A.update_temperature);A.update_button.pack();A.after(5000,A.update_temperature)
